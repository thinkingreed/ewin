...
impl InputComple {
    ...
    pub fn set_disp_name(&mut self, search_str: &str) {
        ...
        self.widget.scrl_v.is_show = menu_set.len() > InputComple::MAX_HEIGHT;
        self.widget.set_disp_name_single_widget(menu_set, None);
    }
...
impl WidgetTrait for InputComple {
    fn clear(&mut self) {
        self.widget.clear();
    }
...
impl Default for InputComple {
    fn default() -> Self {
        ...
        InputComple { widget: Widget::new(WidgetConfig { widget_type: WidgetType::Widget, disp_type: WidgetDispType::Dynamic }), all_words_map: BTreeMap::default(), row_words_vec: vec![RowWords::default()], search_set: BTreeSet::default() }
    }
}
