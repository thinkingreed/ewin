use crate::{core::MenuListTrait, menulist::*};
...
pub struct CtxMenu {
    pub cmd: Cmd,
    pub ctx_menu_place_map: HashMap<TermPlace, MenuListCont>,
    pub menulist: MenuList,
}

impl Default for CtxMenu {
    fn default() -> Self {
        CtxMenu { cmd: Cmd::default(), ctx_menu_place_map: HashMap::new(), menulist: MenuList::new(MenuListConfig { menulist_type: MenuListType::MenuList, disp_type: MenuListDispType::Dynamic }) }
    }
}
