...
impl FromStr for Keys {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "ctrl+a" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'A' } else { 'a' }))),
            "ctrl+b" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'B' } else { 'b' }))),
            "ctrl+c" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'C' } else { 'c' }))),
            "ctrl+d" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'D' } else { 'd' }))),
            "ctrl+e" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'E' } else { 'e' }))),
            "ctrl+f" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'F' } else { 'f' }))),
            "ctrl+g" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'G' } else { 'g' }))),
            "ctrl+h" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'H' } else { 'h' }))),
            "ctrl+i" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'I' } else { 'i' }))),
            "ctrl+j" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'J' } else { 'j' }))),
            "ctrl+k" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'K' } else { 'k' }))),
            "ctrl+l" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'L' } else { 'l' }))),
            "ctrl+m" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'M' } else { 'm' }))),
            "ctrl+n" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'N' } else { 'n' }))),
            "ctrl+o" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'O' } else { 'o' }))),
            "ctrl+p" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'P' } else { 'p' }))),
            "ctrl+q" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'Q' } else { 'q' }))),
            "ctrl+r" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'R' } else { 'r' }))),
            "ctrl+s" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'S' } else { 's' }))),
            "ctrl+t" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'T' } else { 't' }))),
            "ctrl+u" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'U' } else { 'u' }))),
            "ctrl+v" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'V' } else { 'v' }))),
            "ctrl+w" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'W' } else { 'w' }))),
            "ctrl+x" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'X' } else { 'x' }))),
            "ctrl+y" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'Y' } else { 'y' }))),
            "ctrl+z" => Ok(Keys::Ctrl(Key::Char(if cfg!(windows) { 'Z' } else { 'z' }))),
            ...
            "shift+a" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'A' } else { 'a' }))),
            "shift+b" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'B' } else { 'b' }))),
            "shift+c" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'C' } else { 'c' }))),
            "shift+d" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'D' } else { 'd' }))),
            "shift+e" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'E' } else { 'e' }))),
            "shift+f" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'F' } else { 'f' }))),
            "shift+g" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'G' } else { 'g' }))),
            "shift+h" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'H' } else { 'h' }))),
            "shift+i" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'I' } else { 'i' }))),
            "shift+j" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'J' } else { 'j' }))),
            "shift+k" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'K' } else { 'k' }))),
            "shift+l" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'L' } else { 'l' }))),
            "shift+m" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'M' } else { 'm' }))),
            "shift+n" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'N' } else { 'n' }))),
            "shift+o" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'O' } else { 'o' }))),
            "shift+p" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'P' } else { 'p' }))),
            "shift+q" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'Q' } else { 'q' }))),
            "shift+r" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'R' } else { 'r' }))),
            "shift+s" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'S' } else { 's' }))),
            "shift+t" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'T' } else { 't' }))),
            "shift+u" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'U' } else { 'u' }))),
            "shift+v" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'V' } else { 'v' }))),
            "shift+w" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'W' } else { 'w' }))),
            "shift+x" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'X' } else { 'x' }))),
            "shift+y" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'Y' } else { 'y' }))),
            "shift+z" => Ok(Keys::Shift(Key::Char(if cfg!(windows) { 'Z' } else { 'z' }))),
            ...
            "alt+a" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'A' } else { 'a' }))),
            "alt+b" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'B' } else { 'b' }))),
            "alt+c" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'C' } else { 'c' }))),
            "alt+d" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'D' } else { 'd' }))),
            "alt+e" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'E' } else { 'e' }))),
            "alt+f" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'F' } else { 'f' }))),
            "alt+g" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'G' } else { 'g' }))),
            "alt+h" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'H' } else { 'h' }))),
            "alt+i" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'I' } else { 'i' }))),
            "alt+j" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'J' } else { 'j' }))),
            "alt+k" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'K' } else { 'k' }))),
            "alt+l" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'L' } else { 'l' }))),
            "alt+m" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'M' } else { 'm' }))),
            "alt+n" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'N' } else { 'n' }))),
            "alt+o" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'O' } else { 'o' }))),
            "alt+p" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'P' } else { 'p' }))),
            "alt+q" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'Q' } else { 'q' }))),
            "alt+r" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'R' } else { 'r' }))),
            "alt+s" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'S' } else { 's' }))),
            "alt+t" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'T' } else { 't' }))),
            "alt+u" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'U' } else { 'u' }))),
            "alt+v" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'V' } else { 'v' }))),
            "alt+w" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'W' } else { 'w' }))),
            "alt+x" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'X' } else { 'x' }))),
            "alt+y" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'Y' } else { 'y' }))),
            "alt+z" => Ok(Keys::Alt(Key::Char(if cfg!(windows) { 'Z' } else { 'z' }))),
