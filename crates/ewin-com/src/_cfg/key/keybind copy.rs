use crate::{
    _cfg::{
        ...
        lang::lang_cfg::*,
        setting_file_loader::SettingFileLoader,
    },
    def::*,
    global::*,
    log::*,
...
impl Keybind {
    pub fn init(args: &Args, keybind_str: &str) -> String {
        ...
        let (keybind_vec_user, mut err_str) = SettingFileLoader::new(FileType::JSON5, args, FilePath::get_app_config_dir(), KEYBINDING_FILE).load::<Vec<Keybind>>();
