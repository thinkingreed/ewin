...
impl Default for File {
    fn default() -> Self {
        File { name: String::new(), fullpath: String::new(), is_dir: false, ext: String::new(), nl: NEW_LINE_LF_STR.to_string(), enc: Encode::UTF8, bom: None, len: 0, create_time: SystemTime::UNIX_EPOCH, mod_time: SystemTime::UNIX_EPOCH }
    }
}
