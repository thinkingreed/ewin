use crate::model::{FmtType, OpenFileType, SelRange};
...
impl FromStr for KeyCmd {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            // cursor move
            "cursorLeft" => Ok(KeyCmd::CursorLeft),
            "cursorRight" => Ok(KeyCmd::CursorRight),
            "cursorUp" => Ok(KeyCmd::CursorUp),
            "cursorDown" => Ok(KeyCmd::CursorDown),
            "cursorRowHome" => Ok(KeyCmd::CursorRowHome),
            "cursorRowEnd" => Ok(KeyCmd::CursorRowEnd),
            "cursorFileHome" => Ok(KeyCmd::CursorFileHome),
            "cursorFileEnd" => Ok(KeyCmd::CursorFileEnd),
            "cursorPageUp" => Ok(KeyCmd::CursorPageUp),
            "cursorPageDown" => Ok(KeyCmd::CursorPageDown),
            // select
            "cursorLeftSelect" => Ok(KeyCmd::CursorLeftSelect),
            "cursorRightSelect" => Ok(KeyCmd::CursorRightSelect),
            "cursorUpSelect" => Ok(KeyCmd::CursorUpSelect),
            "cursorDownSelect" => Ok(KeyCmd::CursorDownSelect),
            ...
            // mouse
            "mouseOpeSwitch" => Ok(KeyCmd::MouseOpeSwitch),
            // menu
            "help" => Ok(KeyCmd::Help),
            "openMenu" => Ok(KeyCmd::OpenMenu),
