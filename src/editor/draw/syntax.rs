...
impl Default for SyntaxParent {
    fn default() -> Self {
        ...
        Self { syntax_set, theme_set: ThemeSet::load_defaults() }
    }
}
*/
/*
impl SyntaxParent {
    ...
    pub fn load_syntax(&self, extension: &str, theme: Option<&str>) -> Option<Syntax> {
        ...
        Some(Syntax { syntax_set: self.syntax_set, *syntax, theme })
    }*/

/*
    pub fn load_syntax_or_txt(&self, extension: &str, theme: Option<&str>) -> Syntax {
        self.load_syntax(extension, theme).unwrap_or_else(|| self.load_syntax("txt", theme).unwrap())
    }
}
*/
