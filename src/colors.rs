...
impl Colors {
    pub fn set_text_color(str_vec: &mut Vec<String>) {
        str_vec.push(Colors::fg(CFG.get().unwrap().colors.editor.fg));
        str_vec.push(Colors::bg(CFG.get().unwrap().colors.editor.bg));
    }
    pub fn set_rownum_color(str_vec: &mut Vec<String>) {
        str_vec.push(Colors::fg(CFG.get().unwrap().colors.editor.line_number.fg));
        str_vec.push(Colors::bg(CFG.get().unwrap().colors.editor.line_number.bg));
    }

    pub fn set_select_color(str_vec: &mut Vec<String>) {
        str_vec.push(Colors::fg(CFG.get().unwrap().colors.editor.selection.fg));
        str_vec.push(Colors::bg(CFG.get().unwrap().colors.editor.selection.bg));
    }
    pub fn get_sber_bg() -> String {
        return Colors::bg(CFG.get().unwrap().colors.editor.bg);
    }
    pub fn get_sber_fg() -> String {
        return Colors::fg(CFG.get().unwrap().colors.status_bar.fg);
    }

    pub fn get_default_fg() -> String {
        return Colors::fg(CFG.get().unwrap().colors.editor.fg);
    }

    pub fn get_msg_highlight_fg() -> String {
        return Colors::fg(CFG.get().unwrap().colors.msg.highlight_fg);
    }
    pub fn get_msg_normal_fg() -> String {
        return Colors::fg(CFG.get().unwrap().colors.msg.normal_fg);
    }

    pub fn get_msg_warning_fg() -> String {
        // orange
        return Colors::fg(CFG.get().unwrap().colors.msg.warning_fg);
    }

    pub fn get_msg_err_fg() -> String {
        return Colors::fg(CFG.get().unwrap().colors.msg.err_fg);
    }

    pub fn set_eof(str_vec: &mut Vec<String>) {
        str_vec.push(Colors::fg(CFG.get().unwrap().colors.editor.control_char.fg));
